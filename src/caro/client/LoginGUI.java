...
public class LoginGUI extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        jLb_btLogin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLb_btLoginMouseClicked(evt);
            }
        });
    ...
    private void jLb_btLoginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLb_btLoginMouseClicked

        String mail = jTF_Mail.getText();
        String pass = jPF_ResetPass.getText();
        if(mail.isEmpty() || pass.isEmpty()){
            Engine.error("Vui long nhap Mail va Mat khau!");
            return;
        }
        try {
            SendMessage.login(mail, pass);
        } catch (IOException ex) {
            Logger.getLogger(LoginGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_jLb_btLoginMouseClicked
